        ...
        return (
            <div className="container-fluid">
                <div className="container-body">
                    ...
                    <div >
                        <input onChange={this.handleChange} value={this.state.symbol} name="symbol"  className="inputs" type="text" placeholder="Symbol" />
                    </div>
                    <div className="words">
                    ...
                    <div>
                        <input onBlur={() => this.handleSubmit()} onChange={this.handleChange} value={this.state.country} name="country" className="inputs" type="text" placeholder="Country" />
                    </div>
                </div>
            </div>
        );
